...
if __name__ == '__main__':
    ...
    for directory_id in range(1,27):
        ...
        save_path = directory_path + 'DeepIE_50mW_scale10_stack16_fton10mW_144/'
        p = mp.Pool()
        ...
        with torch.no_grad():
            for fnames in tiff_files:
                ...
                for i in range(steps):
                    ...
                    segs = separate_neuron_online_batch(frames_prob, pmaps_b, thresh_pmap_float, minArea, avgArea, useWT=True, useMP=True, p=p)
