...
os.environ['PATH'] += ';C:\\Program Files\\NVIDIA GPU Computing Toolkit\\CUDA\\v12.8'
...
if __name__ == '__main__':
    ...
    # test file
    parser.add_argument('--model_path', default='Z:\LSR\DATA\checkpt\RAFTCAD_result_multiscale_scale_10_stack_28_50mW_fton10mW', help='path to the trained model')
    parser.add_argument('--suns_model_path', default='Z:\LSR\DATA\\2p_bench\suns\\0630\Weights\model_latest.pth', help='path to the trained model')
    ...
    for k, v in state_dict.items():
        name = k.replace('module.', '')  # 去掉module.
        new_state_dict[name] = v
    fff.load_state_dict(new_state_dict)
    ...
    # root_path = 'Z:\\LSR\\DATA\\NAOMi_dataset\\depthrange_200_nodentrites\\'
    # root_path = '/mnt/nas01/LSR/DATA/2p/'
    root_path = 'Z:\LSR\DATA\\2p_bench\\2p_148d\\'
    ...
    for directory_id in directories:
        ...
        directory_path = os.path.join(root_path, directory_id) + '\\'  # path to the data
        # directory_path = 'DATA/'
        loadframe_path = directory_path
        ...
        save_path = os.path.join(root_path, 'DeepIE_50mW_scale10_stack16_fton10mW_0629_180')
        p = mp.Pool()
        ...
        with torch.no_grad():
            for fnames in tiff_files:
                ...
                video_adjust = test_batch_tensorrt(engine, bb,  template, batch_size,overlap_size,
