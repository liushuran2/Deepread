...
if __name__ == '__main__':
    ...
    parser.add_argument('--outf', type=str, default='checkpt/RAFTCAD_result_multiscale_stack_2002', help='data path for vid')
    ...
    parser.add_argument('-e', '--epochs', type=int, default=400, help='Epoch number')
