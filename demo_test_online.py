...
if __name__ == '__main__':
    ...
    dir_video = '/mnt/nas/YZ_personal_storage/Private/MC/2p_benchtop/2p_148d/trial_2p_1/RAFTCAD_multiscale_stack_doublestage' 
    # dir_video = '/mnt/nas/YZ_personal_storage/Private/MC/NAOMi_2p_4/test_seq_6000/1/' 
    ...
    filename_TF_template = 'Shallow-UNet-Neuron-Segmentation_SUNS-master/demo/YST_spike_tempolate.h5' # file name of the temporal filter kernel
    ...
    dir_parent = os.path.join(dir_video, 'SUNS_online') # folder to save all the processed data
    dir_output = os.path.join(dir_parent, 'output_masks online') # folder to save the segmented masks and the performance scores
    dir_params = '/home/user/RAFTCADSUN/Shallow-UNet-Neuron-Segmentation_SUNS-master/training results/output_masks/Optimization_Info_10.mat'
    ...
    weights_path = '/home/user/RAFTCADSUN/Shallow-UNet-Neuron-Segmentation_SUNS-master/training results/Weights/Model_CV10.h5'
    ...
    for CV in list_CV:
        ...
        filename_params_post = dir_params
        # If you used cross_validation == 'use_all' in training, you need to change the "CV" in "format(CV)"
        # to the number of tranining videos used. 
