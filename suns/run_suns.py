...
def suns_online(filename_video, filename_CNN, Params_pre, Params_post, \
        ...
        useWT=False, show_intermediate=True, prealloc=True, display=True, useMP=True, p=None, tiff_flag=True):
    ...
    # Read the dimensions of the video
    if tiff_flag:
        video = tiff.imread(filename_video)
        (nframes, Lx, Ly) = video.shape
    else:
